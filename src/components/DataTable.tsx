...
const columns: GridColDef[] = [
    ...
    { field: 'authors_first_name', headerName: "Authors First Name", flex: 1},
    { field: 'authors_last_name', headerName: "Authors Last Name", flex: 1},
    { field: 'book_title', headerName: "Book Title", flex: 1},
    { field: 'genre', headerName: "Genre", flex: 1},
    { field: 'pages', headerName: "Total Page Number", flex: 1}
]
...
function DataTable() {
  ...
  return (
    <>
        ...
        >
            <h2 className="p-3 bg-slate-300 my-2 rounded">My Library</h2>
